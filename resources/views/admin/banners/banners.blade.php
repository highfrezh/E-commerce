                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ url('admin/add-edit-banner') }}"
                                ...
                                class="btn btn-block btn-success">Add banner
                            </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="tableData" class="table table-striped table-sm table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $banner['id'] }}</td>
                                        <td>
                                            <?php $product_image_path = "images/banner_images/".$banner['image']; ?>
                                            @if(!empty($banner['image']) && file_exists($product_image_path))
                                            <a href="{{ url('images/banner_images/'.$banner['image']) }}">
                                                <img style="width: 70px; height:50px;"
                                                    src="{{ asset('images/banner_images/'.$banner['image']) }}" alt="">
                                            </a>
                                            @else
                                            <img style="width: 70px; height:50px;"
                                                src="{{ asset('images/banner_images/no-image.png') }}" alt="">
                                            @endif
                                        </td>
                                        <td>{{ $banner['link'] }}</td>
                                        <td>{{ $banner['title'] }}</td>
                                        ...
                                        <td>
                                            ...
                                            &nbsp;
                                            <a title="Delete banner" class="confirmDelete" name="banner"
