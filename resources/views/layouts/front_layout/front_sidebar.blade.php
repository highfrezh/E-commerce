...
<div id="sidebar" class="span3">
    ...
    <div class="well well-small">
        ...
        <input type="checkbox" style="margin-top: -3px;" name="fabric[]" id="{{ $fabric }}" value="{{ $fabric }}">
        &nbsp;&nbsp;{{ $fabric }}<br>
        @endforeach
    </div>
    <div class="well well-small">
        ...
        <input type="checkbox" style="margin-top: -3px;" name="sleeve[]" id="{{ $sleeve }}" value="{{ $sleeve }}">
        &nbsp;&nbsp;{{ $sleeve }}<br>
        @endforeach
    </div>
    <div class="well well-small">
        ...
        <input type="checkbox" style="margin-top: -3px;" name="pattern[]" id="{{ $pattern }}" value="{{ $pattern }}">
        &nbsp;&nbsp;{{ $pattern }}<br>
        @endforeach
    </div>
    <div class="well well-small">
        ...
        <input type="checkbox" style="margin-top: -3px;" name="fit[]" id="{{ $fit }}" value="{{ $fit }}">
        &nbsp;&nbsp;{{ $fit }}<br>
        @endforeach
    </div>
    <div class="well well-small">
        ...
        <input type="checkbox" style="margin-top: -3px;" name="occasion[]" id="{{ $occasion }}" value="{{ $occasion }}">
        &nbsp;&nbsp;{{ $occasion }}<br>
        @endforeach
    </div>
    @endif
