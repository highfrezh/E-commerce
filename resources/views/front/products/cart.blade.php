...
<div class="span9">
  ...
  <h3> SHOPPING CART [ <small><span class="totalCartItems">{{
        totalCartItems() }} </span> item(s)</small>]<a href="{{ url('/') }}" class="btn btn-large pull-right"><i
  ...
  <table class="table table-bordered">
    <tbody>
      <tr>
        <td>
          <form id="ApplyCoupon" method="POST" action="javascript:void(0);" class="form-horizontal" @if(Auth::check())
            user="1" @endif>@csrf
