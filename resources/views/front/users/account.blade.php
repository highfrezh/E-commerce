                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span3" type="text" id="address" name="address"
                                value="{{ $userDetails['address'] }}" placeholder="Address">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class=" controls">
                            <input class="span3" type="text" id="pincode" name="pincode"
                                value="{{ $userDetails['pincode'] }}" placeholder="Pincode">
                        </div>
                    </div>
                    <div class="control-group">
            ...
            <div class="well">
                ...
                <form id="passwordForm" action="{{ url('/update-user-pwd') }}" method="post">@csrf
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span3" type="password" id="new_pwd" name="new_pwd" placeholder="New Password">
                        </div>
                    </div>
                    <div class="control-group">
